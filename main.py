...
adjacencies = [malha.mbcore.get_adjacencies(e, 2, True) for e in malha.elem_handles]# Encontrando adjacências para preencher a matriz de conectividade
