...
import mspreprocessor.msCoarseningLib.algoritmo
    ...
    def init_partition(self):
        ...
        if particionador_type != '0':
            if self.dim == 3:
                ...
                [partition[:],coarse_center]  = getattr(mspreprocessor.msCoarseningLib.algoritmo, name_function)(self.volumes.center[:],
